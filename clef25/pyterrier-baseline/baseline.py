...
@click.option('--output-directory', type=click.Path(), required=True, help='The output directory.')
def main(dataset, output_directory):
    ...
    copy(Path(__file__).parent / "ir-metadata.yml", Path(output_directory) / "ir-metadata.yml")
